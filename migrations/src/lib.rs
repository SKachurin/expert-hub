...
mod m20260319_000001_create_experts_table;
mod m20260319_000002_create_calendar_connections_table;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            Box::new(m20260319_000001_create_experts_table::Migration),
            Box::new(m20260319_000002_create_calendar_connections_table::Migration),
